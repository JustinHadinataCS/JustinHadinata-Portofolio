        ...
        <div className="w-full space-y-24 ">
          <div className="flex items-start flex-col space-y-12">
            ...
            <div className="flex flex-wrap gap-4 gap-x-7">
              ...
              <SkillBox title="Zustand">
                <i className="devicon-zustand-plain colored text-3xl"></i>
              </SkillBox>
              <SkillBox title="Redux Toolkit">
                <i className="devicon-redux-original colored text-3xl"></i>
              </SkillBox>
              <SkillBox title="React Router">
                <i className="devicon-reactrouter-plain colored text-3xl"></i>
              </SkillBox>
              <SkillBox title="React Query">
                <svg
                  role="img"
                  viewBox="0 0 24 24"
                  fill="#FF4154"
              ...
              <div className="space-y-6">
                ...
                <div className="w-full bg-gray-100 rounded-lg p-8 flex items-center justify-center">
                  <div className="text-center space-y-4">
                    ...
                    <p className="text-gray-600 max-w-md mx-auto">
                      The first intelligent productivity tracker that unifies
                      your tasks, timer, and focus habits.
                    </p>
                ...
                <div className="space-y-4 flex flex-col items-start">
                  ...
                  <p className="text-gray-700 text-justify">
                    A full-stack productivity application built for developers
                    and professionals who want to achieve deep work. Features
                    intelligent task management, focus tracking, and habit
                    building. Built with modern MERN stack technologies and
                    designed with a clean, intuitive interface.
                  </p>
                </div>
